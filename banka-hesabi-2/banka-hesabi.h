...
ostream& operator <<(ostream& osObject, const bankAccount& bankAcountrObject) {
	osObject << "---------------------------" << endl
		<< "Name: " << bankAcountrObject.personName << endl
		<< "Surname: " << bankAcountrObject.personSurname << endl
		<< "Phone Number: " << bankAcountrObject.personPhone << endl
		<< "Balance: " << bankAcountrObject.accountBalance << endl;
	return osObject;
}
